...
<div class="box">
  ...
  <div class="right"></div>
  <div class="heading">
    <h1 style="background-image: url('/admin/img/social.png');">Testimonials</h1>
<form action="<?=$action; ?>" onsubmit="return check_field('<?=lang('input_request')?>','<?=lang('pwd_request')?>')" method="post" enctype="multipart/form-data" id="form">    
    <div class="buttons">
        ...
        <a href="/admin/offers" class="button"><span><?=lang('cancel')?></span></a>
    </div>
  </div>
  <div class="content">    
	   ...
	   <?php } ?>
        ...
        <?php foreach ($langs as $lang) { ?>        
         <div>
          <table class="form">
            <tr>
              <td><span class="required">*</span>Nume</td>
              <td>
...
<!--             <tr>
              <td>Localitate</td>
              <td>
                 <input name="page[<?=$lang['id_langs']?>][short_<?=$lang['ext']?>]" value="<?=((isset($page['short_'.$lang['ext']])=="")?"":$page['short_'.$lang['ext']])?>"  size="100" value="" />                
              </td>
            </tr>
            <tr>
              <td>Email</td>
	...
	<?php } ?>
       ...
       <table class="form">
<!--         <tr>
              <td>Phone number<span class="help" >from header</span></td>
              <td>
                 <input name="page[<?=$lang['id_langs']?>][link]" value="<?=((isset($page['link'])=="")?"":$page['link'])?>"  size="100" value="" />                
              </td>
            </tr>         -->
