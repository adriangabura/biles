...
<div class="box">
  ...
  <div class="right"></div>
  <div class="heading">
    <h1 style="background-image: url('/admin/img/services.png');">Info</h1>
<form action="<?=$action; ?>" onsubmit="return check_field('<?=lang('input_request')?>','<?=lang('pwd_request')?>')" method="post" enctype="multipart/form-data" id="form">    
    <div class="buttons">
        ...
        <a href="/admin/text" class="button"><span><?=lang('cancel')?></span></a>
    </div>
  </div>
  <div class="content">    
...
<!--            <tr> 
              <td>Link</td>
			  <td>
                 <input name="page[1][short_ro]" value="<?=((isset($page['short_ro'])=="")?"":$page['short_ro'])?>"  size="100" value="" />                
              </td>
			  </tr>-->
<!--			  <tr>
              <td>
